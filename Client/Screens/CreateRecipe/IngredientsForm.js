    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity style={styles.button} onPress={addIngredientField}>
                <Text style={styles.buttonText}>Add ingredient field</Text>
            </TouchableOpacity>
            <FlatList
                ...
                renderItem={({ item, index }) => (
                    <View style={styles.ingredientContainer}>
                        {item.name !== "" ? (
                            <View>
                                <Text>{item.name}</Text>
                                <TouchableOpacity style={styles.button} onPress={() => deleteIngredientField(item.id)}>
                                    <Text style={styles.buttonText}>Delete this ingredient</Text>
                                </TouchableOpacity>
                            </View>
                        ) : (
                            <View>
                                ...
                                />
                                <TouchableOpacity style={styles.button} onPress={searchIngredients}>
            ...
            />
            <TouchableOpacity style={styles.button} onPress={saveIngredients}>
                <Text style={styles.buttonText}>Save Ingredients</Text>
            </TouchableOpacity>
